<template>
  <div v-if="van" class="my-padding flex flex-col gap-10">
    ...
    <img
      ...
      class="
        md:w-3/5 rounded-xl shadow-[0_15px_25px_rgba(0,0,0,0.5)]
      ...
      <RouterLink :to="{ name: 'registration' }">
        <button
          class="
            ...
            rounded-md border-none text-[18px] font-semibold text-white
            bg-[#FF8C38] shadow-[0_15px_25px_rgba(0,0,0,0.5)]
            transition-all duration-300 transform
            hover:bg-[#ff9f59] hover:shadow-[0_8px_20px_rgba(255,140,56,0.6)]
            hover:-translate-y-[2px]
            active:translate-y-0 active:shadow-[0_4px_10px_rgba(255,140,56,0.5)]
          "
        >
          Rent this van
        </button>
