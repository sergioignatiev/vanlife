...
export const useCounterStore = defineStore('counter', () => {
  const data=ref([
    { 
      ...
      imageUrl: "/images/modest-explorer.webp", 
      type: "simple", 
      hostId: "123" 
    },
    { 
      ...
      imageUrl: "/images/beach-bum.webp", 
      type: "rugged",
      hostId: "123" 
    },
    { 
      ...
      imageUrl: "/images/reliable-red.webp", 
      type: "luxury",
      hostId: "456" 
    },
    {
      ...
      imageUrl: "/images/dreamfinder.webp", 
      type: "simple", 
      hostId: "789" 
    },
    { 
      ...
      imageUrl: "/images/the-cruiser.webp", 
      type: "luxury", 
      hostId: "789" 
    }, 
    { 
      ...
      imageUrl: "/images/green-wonder.webp", 
      type: "rugged", 
      hostId: "123"
    }
  ] )
  
const findTypesOfVan=computed(()=>{
 // 1. Get an array of all van types
    const allTypes = data.value.map(van => van.type);
    
    // 2. Use a Set to get only the unique types
    const uniqueTypes = new Set(allTypes);
    
    // 3. Convert the Set back to an array and return it
    return Array.from(uniqueTypes);

})
  return {data,findTypesOfVan }
})
